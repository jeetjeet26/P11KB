 ...
 */ function createSemanticChunks(text, documentType) {
 ...
 */ function extractLogicalChunks(text, structure, documentType) {
  const lines = text.split('\n');
  let chunks = [];
 ...
 */ function extractEnhancedParagraphChunks(text) {
  const chunks = [];
 ...
 */ function extractSentenceBasedChunks(text) {
  const chunks = [];
 ...
 */ function extractCharacterBasedChunks(text) {
  const chunks = [];
...
function extractSectionBasedChunks(lines, structure) {
  const chunks = [];
...
function extractListBasedChunks(lines, structure) {
  const chunks = [];
...
function extractTableBasedChunks(lines, structure) {
  const chunks = [];
...
function postProcessChunks(chunks, documentType) {
